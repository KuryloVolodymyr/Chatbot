...
public class Message {
    ...
    public static Message buildTextMessage(String text) {
        ...
        message.setMid("random");
        message.setSeq(12345);
        message.setText(text);
        return message;
    }

    public static Message buildQuickReplyMessage(String qrText, String qrPayload) {
        Message message = new Message();
        message.setMid("random");
        message.setSeq(12345);
        message.setText(qrText);
        message.setQuickReply(new QuickReply(qrPayload));
        return message;
    }
